 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_security_receive(nvme_link_t l, __u32 nsid, __u32 al, __u8 nssf, __u8 spsp0,
					__u8 spsp1, __u8 secp, void *data, __u32 data_len,
					__u32 *result)
{
	__u32 cdw10 = NVME_SET(secp, SECURITY_SECP) | NVME_SET(spsp0, SECURITY_SPSP0) |
		      NVME_SET(spsp1, SECURITY_SPSP1) | NVME_SET(nssf, SECURITY_NSSF);
	__u32 cdw11 = al;
...
static inline int nvme_get_lba_status(nvme_link_t l, __u32 nsid, __u64 slba,
				      ...
				      struct nvme_lba_status *lbas, __u32 mndw, __u32 *result)
{
...
static inline int nvme_directive_send(nvme_link_t l, __u32 nsid,
				      ...
				      enum nvme_directive_dtype dtype, __u32 cdw12, __u16 dspec,
					       ...
					       struct nvme_id_directives *id)
{
	...
	return nvme_directive_send(l, nsid, NVME_DIRECTIVE_SEND_IDENTIFY_DOPER_ENDIR,
				   NVME_DIRECTIVE_DTYPE_IDENTIFY, cdw12,
				   0, id, sizeof(*id), NULL);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_directive_send_stream_release_identifier(nvme_link_t l, __u32 nsid,
								__u16 stream_id)
{
	return nvme_directive_send(l, nsid, NVME_DIRECTIVE_SEND_STREAMS_DOPER_RELEASE_IDENTIFIER,
				   NVME_DIRECTIVE_DTYPE_STREAMS, 0, stream_id, NULL, 0, NULL);
}
...
{
	return nvme_directive_send(l, nsid, NVME_DIRECTIVE_SEND_STREAMS_DOPER_RELEASE_RESOURCE,
				   NVME_DIRECTIVE_DTYPE_STREAMS, 0, 0, NULL, 0, NULL);
}
...
static inline int nvme_directive_recv_identify_parameters(nvme_link_t l, __u32 nsid,
							  struct nvme_id_directives *id)
{
	return nvme_directive_recv(l, nsid, NVME_DIRECTIVE_RECEIVE_IDENTIFY_DOPER_PARAM,
				   NVME_DIRECTIVE_DTYPE_IDENTIFY, 0, 0, id, sizeof(*id), NULL);
}
...
{
	return nvme_directive_recv(l, nsid, NVME_DIRECTIVE_RECEIVE_STREAMS_DOPER_PARAM,
				   NVME_DIRECTIVE_DTYPE_STREAMS, 0, 0, parms, sizeof(*parms), NULL);
}
						    ...
						    struct nvme_streams_directive_status *id)
{
	...
	return nvme_directive_recv(l, nsid, NVME_DIRECTIVE_RECEIVE_STREAMS_DOPER_STATUS,
				   NVME_DIRECTIVE_DTYPE_STREAMS, 0, 0, id,
				   (__u32)(sizeof(*id) + nr_entries * sizeof(__le16)), NULL);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_directive_recv_stream_allocate(nvme_link_t l, __u32 nsid, __u16 nsr,
						      __u32 *result)
{
	return nvme_directive_recv(l, nsid, NVME_DIRECTIVE_RECEIVE_STREAMS_DOPER_RESOURCE,
				   NVME_DIRECTIVE_DTYPE_STREAMS, nsr, 0, NULL, 0, result);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_capacity_mgmt(nvme_link_t l, __u32 cdw11, __u32 cdw12, __u16 element_id,
				     __u8 op, __u32 *result)
{
	__u32 cdw10 = op | element_id << 16;
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_lockdown(nvme_link_t l, __u8 scp, __u8 prhbt, __u8 ifc, __u8 ofi, __u8 uuidx,
				__u32 *result)
{
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_sanitize_nvm(nvme_link_t l, enum nvme_sanitize_sanact sanact, __u32 ovrpat,
				    bool ause, __u8 owpass, bool oipbp, bool nodas, bool emvs,
				    __u32 *result)
{
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_dev_self_test(nvme_link_t l, __u32 nsid, enum nvme_dst_stc stc,
				     __u32 *result)
{
...
static inline int nvme_virtual_mgmt(nvme_link_t l, enum nvme_virt_mgmt_act act,
				    ...
				    __u32 *result)
{
	__u32 cdw10 = NVME_SET(act, VIRT_MGMT_CDW10_ACT) | NVME_SET(rt, VIRT_MGMT_CDW10_RT) |
			      ...
			      __u64 reftag_u64, __u8 sts, __u8 pif, __u32 *result)
{
	return nvme_io(l, nvme_cmd_verify, nsid, slba, storage_tag, reftag, nlb, control, apptag,
		       appmask, 0, 0, reftag_u64, sts, pif, NULL, 0, NULL, 0, result);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_resv_register(nvme_link_t l, __u32 nsid, __u64 crkey, __u64 nrkey,
				     enum nvme_resv_rrega rrega, enum nvme_resv_cptpl cptpl,
				     bool iekey, __u32 *result)
{
	__le64 payload[2] = {
		htole64(crkey),
				     ...
				     void *data, __u32 data_len, __u32 *result)
{
	...
	__u32 cdw13 = NVME_SET(zsaso, ZNS_MGMT_SEND_ZSASO) |
		      NVME_SET(!!select_all, ZNS_MGMT_SEND_SEL) | NVME_SET(zsa, ZNS_MGMT_SEND_ZSA);
 ...
 * &enum nvme_status_field) or -1 with errno set otherwise.)
 */
static inline int nvme_lm_cdq(nvme_link_t l, __u16 mos, __u16 cntlid, __u8 sel, void *data,
			      __u32 sz, __u16 *cdqid, __u32 *result)
{
	__u32 cdw10 = NVME_SET(sel, LM_CDQ_SEL) | NVME_SET(mos, LM_CDQ_MOS);
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_lm_track_send(nvme_link_t l, __u16 mos, __u16 cdqid, __u8 sel, __u32 *result)
{
	__u32 cdw10 = NVME_SET(sel, LM_TRACK_SEND_SEL) | NVME_SET(mos, LM_TRACK_SEND_MOS);
 ...
 * @l:		Link handle
 * @cso:	Offset: This field specifies the offset, in bytes, within the data available to be
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_lm_migration_send(nvme_link_t l, __u64 cso, __u16 mos, __u16 cntlid,
					 __u16 csuuidi, __u8 sel, __u8 uidx, __u8 stype,
					 __u8 seqind, __u8 csvi, bool dudmq, void *data, __u32 len,
					 __u32 *result)
{
	__u32 cdw10 = NVME_SET(sel, LM_MIGRATION_SEND_SEL) | NVME_SET(mos, LM_MIGRATION_SEND_MOS);
	__u32 cdw11 = 0;

	if (sel == NVME_LM_SEL_SUSPEND) {
		cdw11 = NVME_SET(stype, LM_STYPE) | NVME_SET(cntlid, LM_SUSPEND_CNTLID);
		if (dudmq)
			cdw11 |= NVME_LM_DUDMQ;
	...
	struct nvme_passthru_cmd cmd = {
		...
		.cdw12 = (__u32)cso,
		.cdw13 = (__u32)(cso >> 32),
		.cdw14 = NVME_SET(uidx, LM_MIGRATION_SEND_UIDX),
		.cdw15 = (__u32)(len / sizeof(__u32)),
	};
