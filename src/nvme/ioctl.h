 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_identify_partial(nvme_link_t l, __u16 cntid,
					enum nvme_identify_cns cns,
					enum nvme_csi csi, __u16 cnssid,
					__u8 uidx, __u32 nsid,
					__u32 len, void *data,
					__u32 *result)
{
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_identify(nvme_link_t l, __u16 cntid, enum nvme_identify_cns cns,
				enum nvme_csi csi, __u16 cnssid, __u8 uidx, __u32 nsid,
				void *data, __u32 *result)
{
	return nvme_identify_partial(l, cntid, cns, csi, cnssid, uidx, nsid,
				     NVME_IDENTIFY_DATA_SIZE, data, result);
}

static inline int nvme_identify_cns_nsid(nvme_link_t l, enum nvme_identify_cns cns,
					 __u32 nsid, void *data)
{
	return nvme_identify(l, NVME_CNTLID_NONE, cns, NVME_CSI_NVM,
...
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_CTRL,
				      NVME_NSID_NONE, id);
}
...
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_ALLOCATED_NS,
				      nsid, ns);
}
...
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_NS_ACTIVE_LIST,
				      nsid, list);
}
...
static inline int nvme_identify_allocated_ns_list(nvme_link_t l, __u32 nsid,
			struct nvme_ns_list *list)
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_ALLOCATED_NS_LIST,
				      nsid, list);
}
...
{
	return nvme_identify(l, cntid, NVME_IDENTIFY_CNS_CTRL_LIST,
			     NVME_CSI_NVM, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     NVME_NSID_NONE, cntlist, NULL);
}
...
static inline int nvme_identify_nsid_ctrl_list(nvme_link_t l, __u32 nsid, __u16 cntid,
			struct nvme_ctrl_list *cntlist)
{
	return nvme_identify(l, cntid, NVME_IDENTIFY_CNS_NS_CTRL_LIST,
			     NVME_CSI_NVM, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     nsid, cntlist, NULL);
}
...
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_NS_DESC_LIST,
				      nsid, descs);
}
...
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_NVMSET_LIST,
			     NVME_CSI_NVM, nvmsetid, NVME_UUID_NONE,
			     NVME_NSID_NONE, nvmset, NULL);
}
...
{
	return nvme_identify(l, cntid, NVME_IDENTIFY_CNS_PRIMARY_CTRL_CAP,
			     NVME_CSI_NVM, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     NVME_NSID_NONE, cap, NULL);
}
...
{
	return nvme_identify(l, cntid, NVME_IDENTIFY_CNS_SECONDARY_CTRL_LIST,
			     NVME_CSI_NVM, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     NVME_NSID_NONE, sc_list, NULL);
}
...
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_NS_GRANULARITY,
...
{
	return nvme_identify_cns_nsid(l, NVME_IDENTIFY_CNS_UUID_LIST,
...
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_CSI_NS,
			     csi, NVME_CNSSPECID_NONE, uuidx,
			     nsid, data, NULL);
}
...
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_CSI_CTRL,
			     csi, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     NVME_NSID_NONE, data, NULL);
}
...
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_CSI_NS_ACTIVE_LIST,
			     csi, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     nsid, ns_list, NULL);
}
...
static inline int nvme_identify_allocated_ns_list_csi(nvme_link_t l, __u32 nsid,
			enum nvme_csi csi, struct nvme_ns_list *ns_list)
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_CSI_ALLOCATED_NS_LIST,
			     csi, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     nsid, ns_list, NULL);
}
...
static inline int nvme_identify_ns_csi_user_data_format(nvme_link_t l,
			...
			enum nvme_csi csi, void *data)
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_NS_USER_DATA_FORMAT,
			     csi, user_data_format, uuidx,
			     NVME_NSID_NONE, data, NULL);
}
...
static inline int nvme_identify_iocs_ns_csi_user_data_format(nvme_link_t l,
			...
			enum nvme_csi csi, void *data)
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_CSI_NS_USER_DATA_FORMAT,
			     csi, user_data_format, uuidx,
			     NVME_NSID_NONE, data, NULL);
}
...
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_DOMAIN_LIST,
			     NVME_CSI_NVM, domid, NVME_UUID_NONE,
			     NVME_NSID_NONE, list, NULL);
}
...
{
	return nvme_identify(l, NVME_CNTLID_NONE, NVME_IDENTIFY_CNS_ENDURANCE_GROUP_ID,
...
{
	return nvme_identify(l, cntlid, NVME_IDENTIFY_CNS_COMMAND_SET_STRUCTURE,
			     NVME_CSI_NVM, NVME_CNSSPECID_NONE, NVME_UUID_NONE,
			     NVME_NSID_NONE, iocs, NULL);
}
			...
			struct nvme_zns_id_ns *data)
{
	return nvme_identify_ns_csi(
		l, nsid, NVME_UUID_NONE, NVME_CSI_ZNS, data);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
int nvme_get_log_page(nvme_link_t l, struct nvme_passthru_cmd *cmd,
		      __u32 xfer_len, __u32 len, __u64 lpo, void *log,
		      __u32 *result);
...
static inline int nvme_get_log(nvme_link_t l,
			       ...
			       bool ot, __u8 uidx, __u32 nsid,
			       __u32 xfer_len, __u32 len, __u64 lpo,
			       void *log, __u32 *result)
{
	__u32 numd = (len >> 2) - 1;
	...
	return nvme_get_log_page(l, &cmd, xfer_len, len, lpo, log, result);
}
...
{
	return nvme_get_log(l, rae, NVME_LOG_LSP_NONE,
		lid, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, nsid,
		NVME_LOG_PAGE_PDU_SIZE, len, 0, log, NULL);
}
...
{
	return nvme_get_log(l, false, NVME_LOG_LSP_NONE,
		NVME_LOG_LID_CMD_EFFECTS, NVME_LOG_LSI_NONE, csi,
		false, NVME_UUID_NONE, NVME_NSID_ALL,
		NVME_LOG_PAGE_PDU_SIZE, sizeof(*effects_log), 0, effects_log, NULL);
}
...
{
	return nvme_get_log(l, false, (__u8)((mcda << 1) | NVME_LOG_TELEM_HOST_LSP_CREATE),
		NVME_LOG_LID_TELEMETRY_HOST, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, NVME_NSID_NONE,
		NVME_LOG_PAGE_PDU_SIZE, sizeof(*log), 0, log, NULL);
}
...
static inline int nvme_get_log_telemetry_host(nvme_link_t l, __u64 offset,
			__u32 len, void *log)
{
	return nvme_get_log(l, false, NVME_LOG_TELEM_HOST_LSP_RETAIN,
		NVME_LOG_LID_TELEMETRY_HOST, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, NVME_NSID_NONE,
		NVME_LOG_PAGE_PDU_SIZE, len, offset, log, NULL);
}
...
{
	return nvme_get_log(l, rae, NVME_LOG_LSP_NONE,
		NVME_LOG_LID_TELEMETRY_CTRL, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, NVME_NSID_NONE,
		NVME_LOG_PAGE_PDU_SIZE, len, offset, log, NULL);
}
...
static inline int nvme_get_log_fdp_events(nvme_link_t l, __u16 egid, bool host_events, __u32 offset,
		__u32 len, void *log)
{
	return nvme_get_log(l, false, (__u8)(host_events ? 0x1 : 0x0),
...
static inline int nvme_get_log_ana(nvme_link_t l, enum nvme_log_ana_lsp lsp, bool rae,
				   __u64 offset, __u32 len, void *log)
{
	return nvme_get_log(l, rae, (__u8)lsp,
...
{
	return nvme_get_log(l, rae, lsp,
		NVME_LOG_LID_BOOT_PARTITION, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, NVME_NSID_NONE,
		NVME_LOG_PAGE_PDU_SIZE, len, 0, part, NULL);
}
...
{
	return nvme_get_log(l, false, lsp,
...
{
	return nvme_get_log(l, rae, (__u8)rgo,
...
{
	return nvme_get_log(l, rae, (__u8)rao,
...
{
	return nvme_get_log(l, rae, (__u8)allhoste,
			...
			struct nvme_media_unit_stat_log *mus)
{
	return nvme_get_log(l, false, NVME_LOG_LSP_NONE,
		...
		false, NVME_UUID_NONE, NVME_NSID_NONE,
		NVME_LOG_PAGE_PDU_SIZE, sizeof(*mus), 0, mus, NULL);
}
			...
			struct nvme_supported_cap_config_list_log *cap)
{
	return nvme_get_log(l, false, NVME_LOG_LSP_NONE,
		...
		false, NVME_UUID_NONE, NVME_NSID_NONE,
		NVME_LOG_PAGE_PDU_SIZE, sizeof(*cap), 0, cap, NULL);
}
...
{
	return nvme_get_log(l, false, (__u8)action,
		NVME_LOG_LID_PERSISTENT_EVENT, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, NVME_NSID_ALL,
		NVME_LOG_PAGE_PDU_SIZE, size, 0, pevent_log, NULL);
}
...
{
	return nvme_get_log(l, false, cnscp,
		NVME_LOG_LID_CMD_AND_FEAT_LOCKDOWN, NVME_LOG_LSI_NONE, NVME_CSI_NVM,
		false, NVME_UUID_NONE, NVME_NSID_ALL,
		NVME_LOG_PAGE_PDU_SIZE, sizeof(*lockdown_log), 0, lockdown_log, NULL);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_ns_mgmt(nvme_link_t l,
...
static inline int nvme_ns_mgmt_create(nvme_link_t l, __u8 csi,
				      ...
				      __u32 *nsid)
{
	return nvme_ns_mgmt(l, NVME_NS_MGMT_SEL_CREATE, csi, data,
			    NVME_NSID_NONE, nsid);
}
...
{
	return nvme_ns_mgmt(l, NVME_NS_MGMT_SEL_DELETE, 0, NULL, nsid, NULL);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_ns_attach(nvme_link_t l, enum nvme_ns_attach_sel sel,
...
static inline int nvme_ns_attach_ctrls(nvme_link_t l, __u32 nsid,
			struct nvme_ctrl_list *ctrlist)
{
	return nvme_ns_attach(l, NVME_NS_ATTACH_SEL_CTRL_ATTACH,
			      ctrlist, nsid, NULL);
}
...
static inline int nvme_ns_detach_ctrls(nvme_link_t l, __u32 nsid,
			struct nvme_ctrl_list *ctrlist)
{
	return nvme_ns_attach(l, NVME_NS_ATTACH_SEL_CTRL_DEATTACH,
			      ctrlist, nsid, NULL);
}
 ...
 * received (see &enum nvme_status_field) or a negative error otherwise.
 */
static inline int nvme_security_send(nvme_link_t l, __u8 nssf, __u8 spsp0, __u8 spsp1,
				     __u8 secp, __u32 tl, __u32 nsid, void *data,
